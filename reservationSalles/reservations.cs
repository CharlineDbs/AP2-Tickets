...
namespace reservationSalles2018
{
    public partial class frmReservations : Form
    {
        ...
        private void reservations_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                dgvSemaine.Columns[i].Width = 107;
            ...
            premierLundi = aujourdhui.AddDays(-(jourSem - 1));
        ...
        private void cbxSallesReservation_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void cbxLigues_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar != (char)Keys.Back)
            {
                e.Handled = true;
        ...
        private void cbxReservants_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar != (char)Keys.Back)
            {
                e.Handled = true;
